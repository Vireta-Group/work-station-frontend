...
const AddTeamLeader = () => {
    ...
    const allTeamLeaders = ["John Doe", "Jane Smith", "Michael Lee", "Sophia Khan", "David Miller"];
                    ...
                    <div className="max-w-full overflow-x-auto">
                        <Table>
                            <TableHeader className="border-b border-gray-100 dark:border-white/[0.1]">
                                <TableRow>
                                    <TableCell isHeader className="px-5 py-3 font-medium text-gray-600 dark:text-gray-300">
                                        Department Name
                                    </TableCell>
                                    <TableCell isHeader className="px-5 py-3 font-medium text-gray-600 dark:text-gray-300">
                                        Description
                                    ...
                                    <TableCell isHeader className="px-5 py-3 font-medium text-gray-600 dark:text-gray-300 text-right">
                                        Actions
                                    </TableCell>
                                </TableRow>
                            </TableHeader>
                            ...
                            <div className="border border-gray-300 dark:border-gray-600 rounded-lg mt-2">
                                {allTeamLeaders.map((leader) => (
                                    ...
                                    >
                                        ...
                                        />
                                        <span className="text-gray-700 dark:text-gray-300">{leader}</span>
                                    </label>
                                ))}
                            </div>
                        </div>
