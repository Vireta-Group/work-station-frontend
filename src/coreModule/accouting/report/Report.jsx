...
import { useDispatch, useSelector } from "react-redux";
import {
  fetchExpenseReportByDates,
  selectExpenseReportStatus,
  selectExpenseReportError,
} from "../../../features/expenesReport/expenesReportSlice";
...
export default function Report() {
  ...
  const status = useSelector(selectExpenseReportStatus);
  const error = useSelector(selectExpenseReportError);
  ...
  const handleSubmit = (e) => {
    ...
    const result = dateSchema.safeParse(formDate);
    if (!result.success) {
              ...
              <table className="w-full border-collapse rounded-lg overflow-hidden">
                <thead>
                  <tr className="bg-gray-200 dark:bg-gray-700">
                    <th className="border px-4 py-2 dark:border-gray-600">
                      Purpose
                    </th>
                    <th className="border px-4 py-2 dark:border-gray-600">
                      Amount
